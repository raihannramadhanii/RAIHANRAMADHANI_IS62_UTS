...
<style>
    .custom-hr {
        ...
        width: 35%; /* You can adjust the width of the line */
    ...
    <div class="form-section"> <!-- Added div with class "form-section" -->
        <form action="" method="POST">
            ...
            <div class="form-group" style="margin-top: 30px;" style="margin-bottom: 25px;">
                <label for="name">Kode Pembayaran</label>
            ...
            <div class="form-group" style="margin-top: 30px; margin-bottom: 30px;">
                ...
                <input type="text" class="form-control" style="margin-top: 15px;" id="jns" name="jns" required>
            </div>
